...
This problem is called [referential integrity]({{ site.url }}/reference.html#referential-integrity):
...
using [cascading delete]({{ site.url }}/reference.html#cascading-delete).
However,
...
>
> One of our colleagues has sent us a [CSV]({{ site.url }}/reference.html#comma-separated-values-csv) file containing
