...
the ability to [filter]({{ site.url }}{{ site.baseurl }}/reference.html#filter) data,
i.e.,
...
[wildcard]({{ site.url }}{{ site.baseurl }}/reference.html#wildcard), matching any characters in that
