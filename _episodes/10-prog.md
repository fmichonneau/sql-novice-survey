...
Line 3 then uses this connection to create a [cursor]({{ site.url }}{{ site.baseurl }}/reference.html#cursor).
...
This is called an [SQL injection attack]({{ site.url }}{{ site.baseurl }}/reference.html#sql-injection-attack),
...
We can do this by using a [prepared statement]({{ site.url }}{{ site.baseurl }}/reference.html#prepared-statement)
