...
Line 3 then uses this connection to create a [cursor]({{ site.url }}/reference.html#cursor).
...
This is called an [SQL injection attack]({{ site.url }}/reference.html#sql-injection-attack),
...
We can do this by using a [prepared statement]({{ site.url }}/reference.html#prepared-statement)
