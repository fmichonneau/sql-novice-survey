...
`JOIN` creates
the [cross product]({{ site.url }}{{ site.baseurl }}/reference.html#cross-product)
of two tables,
i.e.,
...
[primary keys]({{ site.url }}{{ site.baseurl }}/reference.html#primary-key)
and [foreign keys]({{ site.url }}{{ site.baseurl }}/reference.html#foreign-key).
