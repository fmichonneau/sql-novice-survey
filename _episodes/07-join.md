...
`JOIN` creates
the [cross product]({{ site.url }}/reference.html#cross-product)
of two tables,
i.e.,
...
[primary keys]({{ site.url }}/reference.html#primary-key)
and [foreign keys]({{ site.url }}/reference.html#foreign-key).
